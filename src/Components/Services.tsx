...
export default function Services() {
    return (
        <div className="bg-[#0D0D0D] text-white  px-4" id="service_layout">
            <div className="container mx-auto text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {services.map((service, index) => (
                        <div key={index} className="bg-[#1A1A1A] p-6 rounded-lg shadow-md text-center hover:shadow-lg transition duration-300">
